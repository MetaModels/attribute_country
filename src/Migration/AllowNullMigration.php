...
namespace MetaModels\AttributeCountryBundle\Migration;
...
class AllowNullMigration extends AbstractMigration
{
    ...
    {
        return 'Allow null values in MetaModels "country" attributes.';
    }
    ...
    private function fixColumn(string $tableName, string $columnName): void
    {
        $this->connection->query(
            sprintf('ALTER TABLE %1$s CHANGE %1$s.%2$s %1$s.%2$s varchar(2) NULL', $tableName, $columnName)
        );
    }
}
