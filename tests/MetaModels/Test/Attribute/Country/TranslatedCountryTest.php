...
class TranslatedCountryTest extends TestCase
{
	...
	public function testNormal()
	{
		...
		$attribute = $this->getMockBuilder('MetaModels\Attribute\Country\Country')
			->setConstructorArgs(array($mockModel))
			->setMethods(array('getMetaModel', 'getRealCountries', 'getCountryNames'))
			->getMock();
		...
		$attribute
			...
			->will($this->returnCallback(function ($language){
