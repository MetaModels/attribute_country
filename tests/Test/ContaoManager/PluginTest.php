...
namespace MetaModels\AttributeCountryBundle\Test\ContaoManager;

use Contao\ManagerPlugin\Bundle\BundlePluginInterface;
use Contao\ManagerPlugin\Bundle\Config\BundleConfig;
use Contao\ManagerPlugin\Bundle\Parser\ParserInterface;
use MetaModels\AttributeCountryBundle\ContaoManager\Plugin;
 ...
 *
 * @covers \MetaModels\AttributeCountryBundle\ContaoManager\Plugin
 */
class PluginTest extends TestCase
{
    ...
    public function testBundleConfig()
    {
        ...
        $this->assertEquals($bundleConfig->getReplace(), ['metamodelsattribute_country']);
    }
}
